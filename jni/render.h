...
#include <jni.h>
/* Header for class com_grafian_bquran_text_NativeRenderer */

#ifndef _Included_com_grafian_bquran_text_NativeRenderer
#define _Included_com_grafian_bquran_text_NativeRenderer
#ifdef __cplusplus
extern "C" {
#endif
/*
